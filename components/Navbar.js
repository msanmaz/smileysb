      ...
      <div className={` w-full md:px-6 p-4 px-0 flex justify-between items-center navh bg-black`}>
        <Link href="/">
          <div className="flex my-4">
            <img src="/logosbs1.2.png" className="cursor-pointer fixed h-[6rem] w-[5rem] -top-[1.2rem] md:-left-0" />
          </div>
        </Link>
        ...
        <div className="flex items-center px-6 md:mt-0">
        ...
        {NAV_ITEMS.map((navItem,index) => (
          ...
          >
            <MenuButton
              ...
              transition='all 0.2s'
              bgColor={'white'}
              fontSize={{ base: '0.4rem', md: '0.8rem' }}
              _hover={{ bg: 'gray.100' }}
